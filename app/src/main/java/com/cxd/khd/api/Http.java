...
import com.cxd.khd.util.ImageUtil;
...
//    public static final String DOMAIN = "http://192.168.3.16";
    ...
    private static final String SK_READ_MSG = DOMAIN + "/logistics/user/message/set_isread";
    private static final String SK_WEIXIN_PAY = DOMAIN + "/logistics/user/pay/wechat_pay";
    ...
    private static final String BK_READ_MSG = DOMAIN + "/logistics/company/message/set_isread";
    ...
    //sk 微信支付运费
    public static void WeiXinPay(Context context,String orderId,String total_fee,BeanCallback callback){
    ...
    //sk 读消息
    public static void skReadMsg(Context context,String messageId,BeanCallback callback){
        OkHttpUtils.post().addHeader("tokenSession", Cache.getInstance().getToken()).url(SK_READ_MSG)
                .addParams("messageId",messageId)
                .build().execute(callback);
    }
    //bk 读消息
    public static void bkReadMsg(Context context,String messageId,BeanCallback callback){
        OkHttpUtils.post().addHeader("tokenSession", Cache.getInstance().getToken()).url(BK_READ_MSG)
                .addParams("messageId",messageId)
                .build().execute(callback);
    }
...
//                .addParams("value",Arrays.toString(value.toArray()))
    ...
    //sk 添加地址
    public static void addOrUpdateSKAddress(Context context,String addressId,String name,String mobile,String address,String longitude,String latitude,String province,String city,String district,String detail,BeanCallback callback){
        ...
        builder.addParams("district",district);
        builder.addParams("detail",detail);
    ...
    //sk 微信 提交订单
    public static void SKSubmitOrder_WEIXIN(Context context,String sendName,String sendMobile,String sendAddress,String  receiveAddress,String receiveMobile,String receiveName,String value,String payType,String servicePrice,String price,String insured,String insuredPrice,String subsidy,String totalPrice,String volume,String weight,String goodsType,String expressCompany,String longitude,String latitude ,BeanCallback callback){
        OkHttpUtils.post().addHeader("tokenSession", Cache.getInstance().getToken()).url(SK_WEIXIN_PAY)
                .addParams("sendName",sendName)
                .addParams("sendMobile",sendMobile)
                .addParams("sendAddress",sendAddress)
                .addParams("receiveAddress",receiveAddress)
    ...
    //sk 微信 支付运费
    public static void payExpressPrice_WEIXIN(Context context,String orderId,String total_fee,BeanCallback callback){
        OkHttpUtils.post().addHeader("tokenSession", Cache.getInstance().getToken()).url(SK_WEIXIN_PAY)
                .addParams("total_fee",total_fee)
                .addParams("orderId",orderId)
                .addParams("type",3+"")
